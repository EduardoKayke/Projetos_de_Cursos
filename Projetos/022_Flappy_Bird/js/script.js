...
var bg2 = new Bg(500, 0, 500, 900, "assets/images/sky.png");
 ...
 // Pipe
 var pipe1 = new Pipe(700, 400, 96, 358, "assets/images/pipe1.png");
 var pipe2 = new Pipe(700, -100, 96, 358, "assets/images/pipe2.png");
...
function draw(){
    ...
    score_text.draw_text(60, "Arial", 225, 100, "Black");
};
